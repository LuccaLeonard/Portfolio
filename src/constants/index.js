...
export const projectData = [
  ...
  },
  {
    ...
    image: projeto3,
    titulo: "QuizJS - v1.0",
    descricao: "Essa é a versão 1.0 de uma ideia que tive para criar um quiz interativo com JavaScript. O objetivo principal foi praticar manipulação do DOM, eventos e lógica de verificação de respostas.",
